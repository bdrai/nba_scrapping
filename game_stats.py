...
class GameStats:
    ...
    def print_game_stats(self):
        print("############################################")
        print(f"{self.game_id} : {self.team1_stats.team_name} - {self.team2_stats.team_name}")
        print("############################################")
